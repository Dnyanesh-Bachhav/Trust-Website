...
function Contact(props) {
  ...
  const sendMail = (e) => {
    ...
    emailjs
      .sendForm(
        props.EMAIL_JS_SERVICE_ID,
        props.EMAIL_JS_TEMPLATE_ID,
        form.current,
        props.EMAIL_JS_PUBLIC_KEY
      )
      .then(
        (result) => {
  ...
  return (
    <section className={`${styles.contact} ${styles.section}`} id="contactus">
      {/* <Toast/> */}
      ...
      >
        ...
        <form
          ref={form}
          onSubmit={sendMail}
          className={`${styles.contact__form} ${styles.grid}`}
        >
          ...
          <div>
            ...
            <button className={`${styles.button} ${styles.button__flex}`}>
              Send Me{" "}
              <i className={`bi bi-send-fill ${styles.button__icon}`}></i>
            </button>
            {/* </a> */}
          </div>
        </form>
